...
function AnimationTest(cool) {
  ...
  return (
    ...
    <div className="boogie">
      ...
      <animated.div class="card2 content" style={{ transform: props.xy.interpolate(trans2) }} >       {(cool.cool.is_image)? <img className="postImage" src={cool.cool.content}></img> : <p style={{color:userColor}}>{cool.cool.content}</p>}
</animated.div>
